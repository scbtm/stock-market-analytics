...
from stock_market_analytics.data_collection.processors.data_quality import (
...
class TestDataQualityValidator:
    ...
    def test_custom_rules_configuration(self):
        ...
        assert (
            "high_low_consistency" not in validator.validation_result.validation_details
        )
        assert (
            "volume_non_negative" not in validator.validation_result.validation_details
        )
