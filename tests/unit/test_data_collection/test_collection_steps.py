...
class TestCreateCollectionPlans:
    ...
    def test_create_collection_plans_mixed(self):
        ...
        metadata_info = [
            {"symbol": "AAPL", "status": "active", "last_ingestion": pd.Timestamp("2023-01-01")},
            {"symbol": "GOOGL", "status": "inactive", "last_ingestion": pd.Timestamp("2023-01-01")}
        ]
...
class TestProcessAndValidateData:
    ...
    @patch('stock_market_analytics.data_collection.collection_steps.DataQualityValidator')
    @patch('stock_market_analytics.data_collection.collection_steps.ContinuousTimelineProcessor')
    def test_process_and_validate_data_success(self, mock_processor_class, mock_validator_class):
    ...
    @patch('stock_market_analytics.data_collection.collection_steps.DataQualityValidator')
    @patch('stock_market_analytics.data_collection.collection_steps.ContinuousTimelineProcessor')
    def test_process_and_validate_data_validation_failure(self, mock_processor_class, mock_validator_class):
...
class TestCollectAndProcessSymbol:
    ...
    @patch('stock_market_analytics.data_collection.collection_steps._process_and_validate_data')
