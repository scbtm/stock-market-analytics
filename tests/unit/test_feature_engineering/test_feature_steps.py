...
class TestBuildFeaturesFromData:
    ...
    def test_build_features_from_data_success(self, tmp_path):
        ...
        with patch('stock_market_analytics.feature_engineering.feature_steps.create_feature_pipeline') as mock_create, \
             patch('stock_market_analytics.feature_engineering.feature_steps.execute_feature_pipeline') as mock_execute, \
             patch('stock_market_analytics.feature_engineering.feature_steps.features_config') as mock_config:
    ...
    def test_build_features_from_data_empty_input(self, tmp_path):
        ...
        with patch('stock_market_analytics.feature_engineering.feature_steps.create_feature_pipeline') as mock_create, \
            ...
            empty_features = pl.DataFrame(schema={
                "date": pl.Date,
                "symbol": pl.Utf8,
                "feature1": pl.Float64
            })
    ...
    def test_build_features_from_data_pipeline_error(self, mock_create, tmp_path):
        ...
        with patch('stock_market_analytics.feature_engineering.feature_steps.features_config') as mock_config:
            mock_config.past_horizon = 30
